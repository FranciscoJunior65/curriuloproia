...
import { getPaymentProviderSetting, updatePaymentProviderSetting, testPaymentProviderConnectionHandler } from '../controllers/settings.controller.js';
...
router.get('/settings/payment-provider', getPaymentProviderSetting);
router.put('/settings/payment-provider', updatePaymentProviderSetting);
router.post('/settings/payment-provider/test', testPaymentProviderConnectionHandler);
