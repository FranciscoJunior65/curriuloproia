...
import { getPlans, createPaymentSession, verifyPayment, getCredits, validateCoupon, adminFreeCredits, getActivePaymentProvider } from '../controllers/payment.controller.js';
...
router.get('/payment/provider', getActivePaymentProvider);
